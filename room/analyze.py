...
class Sentence_Analyzer:
    def __init__(self, room_list=[], default_location=''):
        ...
        self.two_word_town_clues = ['los', 'las', 'new', 'old', 'neu', 'alt', 'bad', 'ober', 'unter', 'west', 'ost', 'nord', 'süd', 'south', 'north' 'east']
    ...
    def analyze(self, text):
        ...
        print('Eingabetext: {}'.format(text))
        print('Zeit jetzt: {}'.format(now))
        ...
        print('Gefundene Zeit: {}'.format(time))
...
def main():
    ...
    print(Analyzer.analyze('Erinner mich in 20 Tagen ans Blumen gießen'))
